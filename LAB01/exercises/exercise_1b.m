...
for i = 1:n
    [~, ~, ~, ~, number_of_calculations_f1(i)] = bisection_method(f1, a1, b1, lambda_values(i), epsilon);
    [~, ~, ~, ~, number_of_calculations_f2(i)] = bisection_method(f2, a1, b1, lambda_values(i), epsilon);
    [~, ~, ~, ~, number_of_calculations_f3(i)] = bisection_method(f3, a1, b1, lambda_values(i), epsilon);
end
