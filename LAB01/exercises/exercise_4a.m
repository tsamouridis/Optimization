...
for i = 1:n
    [~, ~, ~, ~, number_of_calculations_f1(i)] = derivativeBisection_method(f1, a1, b1, lambda_values(i));
    [~, ~, ~, ~, number_of_calculations_f2(i)] = derivativeBisection_method(f2, a1, b1, lambda_values(i));
    [~, ~, ~, ~, number_of_calculations_f3(i)] = derivativeBisection_method(f3, a1, b1, lambda_values(i));
end
